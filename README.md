...
Scraper
Runs the scraper that adds headlines to data/headlines_data.csv.
...
Classifier
Runs the classifier tool to classify scraped headlines into ["politics", "sports", "business", "entertainment", "technology", "health"].
...
Sentiment
Runs the sentiment tool that provides the VADER sentiment score, emotion sentiment classification, or both for headlines or generated headlines.
...
Dashboard
Kicks off the dashboard for viewing the data and analyses. Please make sure all the packages above are installed.
